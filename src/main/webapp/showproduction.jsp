        ...
        <div class="row">
          <%
            ...
            while (iterator.hasNext()) {
              Production pdGetAll = (Production) iterator.next();
              //Грузим альбомы
              ...
              if(pdGetAll.getLink() == Integer.parseInt(request.getParameter("productionId"))){
          %>
          <div class="col-sm-4 thumb-2">
            <h2><%= pdGetAll.getAlbumName()%></h2>
            <a href="MainServlet?action=showProductionAlbom&productionAlbomId=<%= pdGetAll.getId()%>&rootAlbomId=<%= ((Production)(request.getAttribute("pdRead"))).getId()%>">
